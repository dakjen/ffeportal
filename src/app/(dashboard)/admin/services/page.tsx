                ...
                <div>
                  ...
                  <div className="mt-4 flex gap-6 text-sm">
                    <div>
                      ...
                      <span className="font-semibold text-[var(--brand-black)]">${parseFloat(String(service.price || 0)).toFixed(2)}</span>
                    </div>
                    {service.internalCost && (
                      <div>
                        <span className="text-gray-400 block text-xs uppercase tracking-wide">Internal Cost</span>
                        <span className="font-medium text-gray-600">${parseFloat(String(service.internalCost || 0)).toFixed(2)}</span>
                      </div>
                    )}
                    {service.margin && (
                      <div>
                        <span className="text-gray-400 block text-xs uppercase tracking-wide">Margin</span>
                        <span className="font-medium text-green-600">{parseFloat(String(service.margin || 0))}%</span>
                      </div>
                    )}
                  </div>
                </div>
